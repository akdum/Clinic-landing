window.ClinicModel = {
    ...
    Doctors: [
        ...
        { photoName: "tutrumova.jpg", title: { surname: "Тютрюмова", name: "Елена Александровна", spec: "психолог-дефектолог, олигофренопедагог, детский психолог" }, file: "tutrumova.html" },
    ...
    Heroes: [
        ...
        { area: 'exams', order_img: 'order-1', order_text: 'order-2', imgName: 'hero-exams-1.jpg', title: 'Психологическая подготовка к ЕГЭ', text: 'Напряженный график, школьные задания, занятия с репетитором, большой объем информации, недосып, напряжение, стресс… Ещё и давление учителей, и беспокойство родителей.' },
        { area: 'exams', order_img: 'order-2', order_text: 'order-1', imgName: 'hero-exams-2.jpg', title: '', text: '<p>Всё это характерно для выпускников, которым предстоят экзамены!</p><p>Как справиться с волнением, сосредоточиться и спокойно выполнить всё на отлично?</p>' },
        { area: 'exams', order_img: 'order-1', order_text: 'order-2', imgName: 'hero-exams-3.jpg', title: '<p>Предлагаем Вам курсы <strong>психологической подготовки к ЕГЭ</strong> «Экзамены без волнения».</p>', text: '<p><strong>Наша цель:</strong> научить управлять тревогой и волнением, концентрировать внимание, повысить стрессоустойчивость, обрести спокойствие и уверенность в своих способностях.</p><p><strong>Для кого:</strong> для выпускников 9 и 11 классов, кому предстоит экзамен, а также для всех, чья тревожность мешает спокойно жить и работать.</p>' },
        { area: 'exams', order_img: 'order-2', order_text: 'order-1', imgName: 'hero-exams-4.jpg', title: '', text: '<p><strong>Курс рассчитан</strong> на 15 еженедельных занятий, продолжительностью один час. <strong>Организационная встреча 9 января 2018 года</strong></p>' },
    ],
    MedInfo: [

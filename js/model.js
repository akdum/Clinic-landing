window.ClinicModel = {
    ...
    MedInfo: [
        { img: 'МИ_04.jpg', issueName: 'МИ_04.pdf', current: "yes", content: "<li>Инсульт - это не приговор</li><li>Кинезотерапия на подвесных системах «Экзарта»</li><li>Сеть многопрофильных  клиник «Доктор плюс»</li>" }
    ]
}